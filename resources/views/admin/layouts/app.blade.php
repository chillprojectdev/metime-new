...
<head>
    ...
    <title>Metime I Admin Dashboard</title>
    ...
    <!-- Toggles CSS -->
    <link href="assets/scrooge/vendors/jquery-toggles/css/toggles.css" rel="stylesheet" type="text/css">
    <link href="assets/scrooge/vendors/jquery-toggles/css/themes/toggles-light.css" rel="stylesheet" type="text/css">
                        ...
                        <div class="notifications-nicescroll-bar">
                                ...
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="assets/scrooge/dist/img/avatar1.jpg" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="media">
                                    <div class="media-img-wrap">
                                        <div class="avatar avatar-sm">
                                            <img src="assets/scrooge/dist/img/avatar2.jpg" alt="user" class="avatar-img rounded-circle">
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div>
