@extends('admin.layouts.app')
	@section('style')
		<!-- Morris Charts CSS -->
		<link href="assets/scrooge/vendors/morris.js/morris.css" rel="stylesheet" type="text/css" />
	
		<!-- Toastr CSS -->
		<link href="assets/scrooge/vendors/jquery-toast-plugin/dist/jquery.toast.min.css" rel="stylesheet" type="text/css">
	@endsection
        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container mt-xl-50 mt-sm-30 mt-15">
				...
				<div class="hk-pg-header align-items-top">
					...
					<div class="d-flex">
						<a class="btn btn-sm btn-outline-light btn-wth-icon icon-wthot-bg mr-15 mb-15"><span class="icon-label"><i class="fa fa-envelope-o"></i> </span><span class="btn-text">Email </span></a>
									...
									<div class="card-body">
										<div class="user-activity user-activity-sm">
											<div class="media">
												<div class="media-img-wrap">
													<div class="avatar avatar-xs">
														<img src="assets/scrooge/dist/img/avatar3.jpg" alt="user" class="avatar-img rounded-circle">
													</div>
												</div>
											...
											<div class="media">
												<div class="media-img-wrap">
													<div class="avatar avatar-xs">
														<img src="assets/scrooge/dist/img/avatar4.jpg" alt="user" class="avatar-img rounded-circle">
													</div>
												</div>
												<div class="media-body">
													<div>
								...
								<div class="hk-row">
										...
										<div class="card card-sm">
											<div class="card-body pa-0">
												<div class="pa-15 mb-10">
													<span class="d-block font-14 font-weight-500 text-dark">Customers</span>
													<div class="d-flex align-items-center justify-content-between">
														<div class="display-5 font-weight-400 text-dark">{{$customers_count}}</div>
												...
												<div class="d-flex align-items-center justify-content-center mb-3">
													<a type="button" class="btn btn-outline-primary btn-rounded btn-sm pr-2 pl-2" href="{{ route('admin.customers') }}">Data</a>
												</div>
											</div>
										</div>
									</div>
									<div class="col-lg-4">
										<div class="card card-sm">
											<div class="card-body pa-0">
												<div class="pa-15 mb-10">
													<span class="d-block font-14 font-weight-500 text-dark">Orders</span>
													<div class="d-flex align-items-center justify-content-between">
	...
	<script src="assets/scrooge/vendors/waypoints/lib/jquery.waypoints.min.js"></script>
	<script src="assets/scrooge/vendors/jquery.counterup/jquery.counterup.min.js"></script>
	
	<!-- Easy pie chart JS -->
    <script src="assets/scrooge/vendors/easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
	
	<!-- Sparkline JavaScript -->
    <script src="assets/scrooge/vendors/jquery.sparkline/dist/jquery.sparkline.min.js"></script>
	
	<!-- Morris Charts JavaScript -->
    <script src="assets/scrooge/vendors/raphael/raphael.min.js"></script>
    <script src="assets/scrooge/vendors/morris.js/morris.min.js"></script>
   
	<!-- EChartJS JavaScript -->
    <script src="assets/scrooge/vendors/echarts/dist/echarts-en.min.js"></script>
    
	<!-- Peity JavaScript -->
    <script src="assets/scrooge/vendors/peity/jquery.peity.min.js"></script>
   
	<!-- Toastr JS -->
    <script src="assets/scrooge/vendors/jquery-toast-plugin/dist/jquery.toast.min.js"></script>
    
    <!-- Init JavaScript -->
    <script src="assets/scrooge/dist/js/init.js"></script>
	<script src="assets/scrooge/dist/js/dashboard-data.js"></script>
	@endsection